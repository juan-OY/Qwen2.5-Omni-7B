#https://github.com/intel/ipex-llm/blob/main/docs/mddocs/Quickstart/install_pytorch26_gpu.md
...
def _load_model_processor(args):
    ...
    model = Qwen2_5OmniModel.from_pretrained(args.checkpoint_path, enable_audio_output=True)
...
def _launch_demo(args, model, processor):
    ...
    def predict(messages, voice=DEFAULT_VOICE):
        ...
        text_ids, audio = model.generate(**inputs, use_audio_in_video=True, thinker_max_new_tokens=2048)
...
DEFAULT_CKPT_PATH = "Qwen2.5-Omni-7B"
def _get_args():
